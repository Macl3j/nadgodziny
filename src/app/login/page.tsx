...
export default function LoginPage() {
    return (
        <div className="flex items-center justify-center min-h-screen bg-slate-50 dark:bg-slate-950">
            <form action={login} className="w-full max-w-sm p-8 bg-white dark:bg-slate-900 rounded-xl shadow-lg space-y-6 border border-slate-200 dark:border-slate-800">
